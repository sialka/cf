                            ...
                            <table id="tableResults" class="table table-bordered p-0 m-0" style="border-bottom: 0px solid white">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if($perfil->admin == 1): $col = "30%" ?>
                                        <?= $this->element('th_sort', [ 'th' => ['10%', 'Users.last_access', __('Acesso') ] ]); ?>
                                        <?php endif; ?>
                                        <?= $this->element('th_sort', [ 'th' => ['05%', 'Users.status', __('Status') ] ]); ?>
                                        <th class="text-center" width="<?= $col; ?>"></th>
                                        ...
                                        <tr class="vAlignMiddle">
                                            ...
                                            <td class="text-left px-3">
                                                <?php 
                                                    ...
                                                    if($data != null){
                                                        $time = new FrozenTime($user->last_access);
                                                        echo $time->modify('-3 hours');
                                                    }else{
                                                        echo "-";
                                                    } 
                                                ?>
