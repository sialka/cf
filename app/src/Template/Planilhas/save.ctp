<?php
    ...
    $colunas = "col-lg-2 col-md-2";
    
    if(in_array($mode,['add'])){
        $colunas = "col-lg-3 col-md-3";
    }    
            ...
            <div class="card-body normal">
                ...
                <?php if(in_array($mode,['edit', 'view'])) { ?>
                    <div class="row">
                        ...
                        <?php if($perfil->Users): ?>
                        <div class="form-group col-lg-3 col-md-3 col-sm-3 col-sx-12">
                            <label for="id" class="strong">Usuário</label>
                            <?=                            
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-3 col-sx-12">
                            <label for="id" class="strong">Atualização</label>
                            <?=                            
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="dt_lancamento" class="strong">
                            Dia do Lançamento
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group <?= $colunas; ?> col-sm-12">
                        <label for="dt_vencimento" class="strong">
                            Dia do Vencimento 
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group <?= $colunas; ?> col-sm-12">
                        <label for="dt_pagamento" class="strong">
                            Dia do Pagamento
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                   ...
                   <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        <label for="nota_fiscal" class="strong">
                            Nota Fiscal
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-12">
                        <label for="fornecedor_nome" class="strong">
                            Fornecedor
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <?php /*
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="cotacoes" class="strong">
                            3 Cotações ?
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="pagto_atraso" class="strong">
                            Pagamento em atraso ?
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <?php /*
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="visto" class="strong">
                            Visto de Lançamento no SIGA ?
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="serv_tomados" class="strong">
                            Serviços Tomados ?
                            <span class="text-danger">*</span>
                        </label>
                        <?=
                    ...
                    <div class="form-group col-lg-2 col-md-2 col-sm-12">
                        <label for="falta_contrato" class="strong">
                            Falta de Contrato
                            <span class="text-danger">*</span>
                        </label>
                        <?=
