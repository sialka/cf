                            ...
                            <table id="tableResults" class="table-responsive-lg table table-bordered p-0 m-0 no-border">
                                <thead>
                                    <tr class="normal strong">                                   
                                        ...
                                        <?php 
                                        if($perfil->cad_users): 
                                            echo "<th class='text-left px-3' width='05%'>Usuário</th>";
                                            $colForn = "15%";
                                        else: 
                                            $colForn = "20%";
                                        endif; 
                                        ...
                                        <?= $this->element('th_sort', [ 'th' => ['<?= $colForn?>', 'Planilhas.fornecedor_nome', __('Fornecedor') ] ]); ?>
                                ...
                                <tbody class="">
                                    <?php foreach ($planilhas as $planilha): ?>
                                        <tr class="normal">
                                            ...
                                            <?php 
                                            if($perfil->cad_users):                                             
                                                echo "<td class='text-left px-3'>";
                                                echo h($planilha->Users->username);
                                                echo "</td>";
                                            endif; 
                                            ?>     
