                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php 
                                    if($perfil->admin): 
                                        echo $this->Html->image('perfil1.png', ["class"=>"img-profile rounded-circle"]);
                                    else:
                                        if($perfil->cad_users):
                                            echo $this->Html->image('perfil2.png', ["class"=>"img-profile rounded-circle"]);
                                        else:
                                            echo $this->Html->image('perfil3.png', ["class"=>"img-profile rounded-circle"]);
                                        endif;
                                    endif; 
                                ?>
                            </a>
